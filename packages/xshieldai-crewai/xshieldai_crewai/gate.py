...
# @rule:KOS-YK-015 import from xshieldai-langchain; do not re-implement gate logic
from __future__ import annotations

import uuid
from typing import Any, Dict, Optional

from xshieldai_langchain import AegisClient, KavachGateCallback, KavachGateError
...
class CrewAIBudgetGuard:
    ...
    Usage::
        ...
        from xshieldai_crewai import CrewAIBudgetGuard
...
def governed_kickoff(
    ...
    *,
    ...
    Usage::
        ...
        from xshieldai_crewai import governed_kickoff
